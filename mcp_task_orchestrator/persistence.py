...
class PersistenceManager:
    ...
    def acquire_lock(self, resource_name: str, timeout: int = 10) -> filelock.FileLock:
    ...
    def save_task_breakdown(self, breakdown: TaskBreakdown) -> None:
        ...
        """
        # Acquire a lock for this task
        with self.acquire_lock(f"task_{breakdown.parent_task_id}"):
    ...
    def load_task_breakdown(self, parent_task_id: str) -> Optional[TaskBreakdown]:
        ...
        """
        # Acquire a lock for this task
        with self.acquire_lock(f"task_{parent_task_id}"):
            # Check active tasks
